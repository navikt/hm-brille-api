...
class SendTilUtbetalingScheduler(
    ...
    override suspend fun action() {
        val utbetalinger = utbetalingService.hentUtbetalingerForOppdrag(batchDato = LocalDate.now().minusDays(dager),
           opprettetFor = 2.minutes) // hent kun de som har blitt registrert minst x minutter siden.
