...
import no.nav.hjelpemidler.brille.kafka.River.PacketListener.Companion.Name
...
class River(rapidsConnection: RapidsConnection, private val randomIdGenerator: RandomIdGenerator = RandomIdGenerator.Default) :
