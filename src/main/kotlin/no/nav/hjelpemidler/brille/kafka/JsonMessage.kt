...
open class JsonMessage(
    ...
    companion object {
        ...
        fun newMessage(eventName: String, map: Map<String, Any> = emptyMap(), randomIdGenerator: RandomIdGenerator? = null) = newMessage(
            mapOf(
                EventNameKey to eventName
            ) + map,
            randomIdGenerator
        )
        fun newNeed(behov: Collection<String>, map: Map<String, Any> = emptyMap(), randomIdGenerator: RandomIdGenerator? = null) = newMessage(
            "behov",
            mapOf(
