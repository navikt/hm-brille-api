    ...
    override fun hentVedtakForOptiker(fnrInnsender: String, vedtakId: Long): OversiktVedtak? {
        ...
        val sql = """
            SELECT
                ...
                COALESCE(v.vilkarsvurdering, vs.vilkarsvurdering) -> 'grunnlag' -> 'brilleseddel' ->> 'høyreSylinder' AS høyreSylinder,
                COALESCE(v.vilkarsvurdering, vs.vilkarsvurdering) -> 'grunnlag' -> 'brilleseddel' ->> 'venstreSfære' AS venstreSfære,
                COALESCE(v.vilkarsvurdering, vs.vilkarsvurdering) -> 'grunnlag' -> 'brilleseddel' ->> 'venstreSylinder' AS venstreSylinder,
