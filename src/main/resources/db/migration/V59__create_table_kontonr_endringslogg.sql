...
INSERT INTO (orgnr, fnr_oppdatert_av, kontonr, opprettet) SELECT orgnr, fnr_innsender, kontonr, opprettet FROM virksomhet_v1 WHERE opprettet = oppdatert;
...
INSERT INTO (orgnr, fnr_oppdatert_av, kontonr, opprettet) SELECT orgnr, fnr_oppdatert_av, kontonr, oppdatert FROM virksomhet_v1 WHERE opprettet <> oppdatert;
